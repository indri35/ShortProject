        ...
        <section class="content">
          <div class="box">
            <div class="box box-primary">
              ...
              <!-- form start -->
              <?php echo form_open('humas/update'); ?>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select type="text" name="hak_akses" value="<?php echo $user['hak_akses']; ?>" class="form-control" placeholder="Hak Akses">
                    ...
                    <div class="form-group">
                      <label>NIK</label>
                      <input type="text" name="nik" value="<?php echo $user['nik']; ?>" class="form-control"  placeholder="Ex. 0123456789">
                    </div>
                    <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="no_tlpn" value="<?php echo $user['no_tlpn']; ?>" class="form-control"  placeholder="Ex. 02665457">
                    </div>
                    <div class="form-group">
                      <label>No. Handphone</label>
                      <input type="text" name="no_hp" value="<?php echo $user['no_hp']; ?>" class="form-control"  placeholder="Ex. 085749654">
                    </div>
                    <div class="form-group">
                      <label>Email</label>
                      <input type="text" name="email" value="<?php echo $user['email']; ?>" class="form-control"  placeholder="aaa@domain.com">
                    </div>
