...
<html>
    ...
    <link href="<?php echo base_url('assets/admin/plugins/datatables/dataTables.bootstrap.min.css')?>" rel="stylesheet">
...
<body>
    <div class="container">
        ...
        <h3>dokumen Data</h3>
        <br />
        <button class="btn btn-success" onclick="add_dokumen()"><i class="glyphicon glyphicon-plus"></i> Add dokumen</button>
...
function edit_dokumen(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="nama_berkas"]').val(data.nama_berkas);
            $('[name="kategori"]').val(data.kategori);
            $('[name="deskripsi"]').val(data.deskripsi);
            $('[name="kode_skpd"]').datepicker('update',data.kode_skpd);
...
function delete_dokumen(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('dokumen/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    if(list_id.length > 0)
    {
        if(confirm('Are you sure delete this '+list_id.length+' data?'))
        {
            $.ajax({
                type: "POST",
                data: {id:list_id},
                url: "<?php echo site_url('dokumen/ajax_bulk_delete')?>",
                dataType: "JSON",
                success: function(data)
                {
                    if(data.status)
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Kode Berkas</label>
                            <div class="col-md-9">
                                <input name="kode_berkas" placeholder="First Name" class="form-control" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="nama_berkas" placeholder="Last Name" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Kode SKPD</label>
                            <div class="col-md-9">
                                <input name="kode_skpd" placeholder="kode" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
