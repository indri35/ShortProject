    ...
    <div class="page-banner" style="padding:40px 0; background: url(<?php echo base_url() ?>assets/user/margo/images/slide-02-bg.jpg) center #f9f9f9;">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <h2>Kontak Kami</h2>
            <p>Pejabat Pengelola Informasi dan Dokumentasi (PPID) Kota Bogor</p>
            <p>Bagian Hubungan Masyarakat Sekretariat Daerah Kota Bogor</p>
          </div>
          <div class="col-md-6">
    ...
    <div id="content">   
      <div class="container">
        <div class="page-content">
            <div class="row">
                <div class="col-lg-6">
                    <h3 class="classic-title"><span><strong>Alamat</strong></span></h3>
                    <p>Jl. Ir. H. Juanda Nomor 10-Bogor 16121
                    <br/>Telp. (0251) 8321075 dan Fax. (0251) 8326530
                    <br/>Email : <a href="mailto:bag.humas@kotabogor.go.id" target="_top">bag.humas@kotabogor.go.id</a>
                    <br/>Twitter: <a href="https://twitter.com/pemkotabogor?lang=en" target="_blank">@pemkotabogor</a>
                    <br/>Fanpage Facebook: <a href="https://www.facebook.com/PemerintahKotaBogor/" target="_blank">Pemkot Bogor</a></p>
                </div>
                <div class="col-lg-6">
                    <h3 class="classic-title"><span><strong>Peta</strong></span></h3>
