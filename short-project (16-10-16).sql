...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 16, 2016 at 05:57 PM
...
CREATE TABLE IF NOT EXISTS `t_doc_req` (
  `no_req` int(3) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `t_doc_req` (`no_req`, `id_req`, `kode_berkas`, `berkas_upload`, `date_upload`, `form_keberatan`) VALUES
...
(33, 53, '55', NULL, '', ''),
(34, 53, 'rrrrrr', NULL, '', ''),
(36, 55, 'kumse', 'map.JPG', '2016-10-16', ''),
(37, 56, '123222', NULL, '', ''),
(38, 56, 'kk', NULL, '', ''),
(39, 57, '123222', NULL, '', '');
