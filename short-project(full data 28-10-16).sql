...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Oct 28, 2016 at 10:54 AM
...
(25, 46, 'berkas212135', 'd-helm.JPG', '2016-10-18', '5.PNG', 'tanggapi berkas rumah', NULL, '2016-10-28'),
(26, 47, 'berkas212135', NULL, '', '', NULL, NULL, NULL),
(27, 48, 'balebak131', NULL, '', '', NULL, NULL, NULL),
(28, 49, 'berkas111', NULL, '', '', NULL, NULL, NULL),
(29, 50, '55', 'd-helm.JPG', '2016-10-18', '5.PNG', 'aaaaaaaaaa bbbbbbbbbb ccccccccccc', NULL, '2016-10-28'),
...
(43, 60, '55', NULL, '2016-10-23', '', NULL, 'tolakkkkkkkk', NULL),
(44, 60, 'rrrrrr', 'akua.JPG', '2016-10-23', '', 'ini akua', NULL, NULL),
(45, 61, '55', 'dokumen_baru1.JPG', '2016-10-25', '', 'pake pake file name', NULL, NULL),
(46, 61, 'rrrrrr', NULL, '', '', NULL, NULL, NULL),
(47, 62, '55', 'bismilah.JPG', '2016-10-24', '', 'ku pinang kau dengan bismilah', NULL, NULL);
...
(25, '22555', '2016-10-25', 'berkas ini', 'ini daun.jpg', 'Informasi Berkala', 'ini ini ini', 'Inspektorat');
...
(61, 'aaaaaaaaaaaaaaaaaaa', '3333', '2016-10-23', 'map.jpg\r\n', 'perorangan'),
(62, 'untuk masa depan yg cerah', '446887776', '2016-10-24', 'saliiim.JPG', 'perorangan');
...
(7, 3, 'Inspektorat', '323423233', 'mimi salim', 'sukabumi', '212135', '085719579827', 'mimi@gmail.com', 'logo-knpi.jpg', 'dde6ecd6406700aa000b213c843a3091', ''),
(9, 2, 'Sekda', '5445', 'humas', 'sukabumen', '333', '3333', 'humas@gmail.com', 'foto.jpg', '94da7343e47802652a24444298012b8c', ''),
...
--
ALTER TABLE `t_doc_req`
  MODIFY `no_req` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
--
